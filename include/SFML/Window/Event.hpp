...
public:
    ...
    ////////////////////////////////////////////////////////////
    /// \brief Mouse high-precision wheel events parameters
    ///        (MouseHorizontalWheelMoved, MouseVerticalWheelMoved)
    ///
    ////////////////////////////////////////////////////////////
    struct MouseHighPrecisionWheelEvent
    {
        float delta; ///< Number of ticks the wheel has moved (positive is up/left, negative is down/right)
        int x;       ///< X position of the mouse pointer, relative to the left of the owner window
        int y;       ///< Y position of the mouse pointer, relative to the top of the owner window
    };
    ...
    enum EventType
    {
        ...
        MouseHorizontalWheelMoved, ///< The mouse wheel was tilted horizontally (data in event.mouseHighPrecisionWheel)
        MouseVerticalWheelMoved,   ///< The mouse wheel was scrolled vertically (data in event.mouseHighPrecisionWheel)
    ...
    union
    {
        ...
        MouseHighPrecisionWheelEvent mouseHighPrecisionWheel; ///< Mouse high-precision wheel event parameters (Event::MouseHorizontalWheelMoved, Event::MouseVerticalWheelMoved)
